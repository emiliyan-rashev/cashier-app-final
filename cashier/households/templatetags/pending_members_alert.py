...
from cashier.households.views import inactive_users
...
def pending_members_alert(context):
    if context.request.user.is_authenticated:
        ...
        if context.request.user.is_superuser:
            ...
            member_list = UserProfile.objects.filter(Q(household=None), Q(apartment=household), ~Q(user__in=inactive_users()))
