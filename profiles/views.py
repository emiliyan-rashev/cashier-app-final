...
from mixins.mixins import OwnerOrSuperUserRequiredMixin, SuperUserRequiredMixin
from profiles.forms import EditProfileForm, DeleteProfileForm
...
class DeleteProfileView(BootStrapFormMixin, OwnerOrSuperUserRequiredMixin, FormView):
